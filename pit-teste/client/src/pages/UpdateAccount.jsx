...
const UpdateAcc = () => {
  ...
  return (
    <>
      <div className="updateModal flex flex-col justify-around items-center">
        ...
        >
          ...
          <div className="multInputContainer flex justify-center">
            <input
              type="number"
              id="dob_day"
              name="dob_day"
          ...
          <input type="submit" className="w-11/12" onSubmit={handleChange} />
        </form>
      </div>
    </>
  );
